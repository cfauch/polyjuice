 ...
 *
 */
public final class ImmutableContent extends AbsContent {
    ...
    /**
     * Builder used to build immutable content.
     * 
     * @author c.fauch
     *
     */
    public static final class Builder extends AbsContent {
        ...
        /**
         * Build a new Immutable content.
         * 
         * @return the new immutable content
         */
        public ImmutableContent build() {
            return new ImmutableContent(this);
        }
    }
    
    /**
     * The private constructor called by the builder.
     * 
     * @param builder
     */
    private ImmutableContent(final Builder builder) {
        super(Collections.unmodifiableList(new ArrayList<>(builder.getOrderedContents())));
