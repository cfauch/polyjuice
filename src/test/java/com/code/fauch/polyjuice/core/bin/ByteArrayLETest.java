...
public class ByteArrayLETest {
    ...
    public void testGetByte() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b10011101, (byte) 0b11011010}, 5);
    ...
    public void testGetByteOutOfRange() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b11011010}, 5);
            Assert.assertEquals(0b01010, ba.getByte(5));
    }
    ...
    @Test
    public void testGet() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b01110010, (byte) 0b10011101, (byte) 0b11011010}, 5);
            Assert.assertArrayEquals(new byte[] {(byte) 0b11010111, (byte) 0b00101001}, ba.get(15));
    }

    @Test
    public void testGetSeveralBytes() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b00001111, (byte) 0b01110010, (byte) 0b10011101, (byte) 0b11011010}, 5);
    ...
    @Test
    public void testSet() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b00100011, (byte) 0b00010100, (byte) 0b10011101, (byte) 0b11011010}, 5);
            ba.set(new byte[] {(byte) 0b11011010, (byte) 0b01110001, (byte) 0b101000}, 22);
            Assert.assertArrayEquals(new byte[] {(byte) 0b01000011, (byte) 0b00111011, (byte) 0b00001110, (byte) 0b11011101}, ba.getBytes());
    }
    ...
    public void testSetOneByte() {
            ...
            Assert.assertArrayEquals(new byte[] {(byte) 0b01011101, (byte) 0b11011101}, ba.getBytes());
    }

    @Test
    public void testGetOffset0() {
            final ByteArrayLE ba = ByteArrayLE.wrap(new byte[] {(byte) 0b11000001, (byte) 0b11111101}, 0);
